...
zzed = TestFindVariableAssignments()

zzed.test_class_with_nested_fn()
zzed.test_multiple_parameters()
zzed.test_single_parameter()
zzed.test_multiple_assignments()
zzed.test_ignores_values()
zzed.test_ignores_edge_cases()
zzed.test_regular_assignment()
